...
public class NewGroupStep2Fragment extends BaseFragment {
    ...
    protected void initViewsAndSetEvent() {
        ...
        if (ActivityCompat.checkSelfPermission(
                mActivity, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
            ...
            }).AskForContact(mActivity, StaticField.PermissionRequestCode.addContactUsersInNewGroup);
            return;
        }
